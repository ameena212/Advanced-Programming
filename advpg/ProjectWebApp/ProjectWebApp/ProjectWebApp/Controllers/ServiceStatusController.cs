...
namespace ProjectWebApp.Controllers
{
    public class ServiceStatusController : Controller
    {
        ...
        public ServiceStatusController(DBHomeServiceContext context)
        {
            _context = context;
        }
        ...
        {
            if (id == null || _context.ServiceStatuses == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("ServiceStatusId,ServiceState")] ServiceStatus serviceStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServiceStatusId,ServiceState")] ServiceStatus serviceStatus)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DBHomeServiceContext.ServiceStatuses'  is null.");
            }
            var serviceStatus = await _context.ServiceStatuses.FindAsync(id);
            if (serviceStatus != null)
            {
